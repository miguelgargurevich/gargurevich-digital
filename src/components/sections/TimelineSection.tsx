...
const STEPS = [
  {
    ...
    description: 'Definimos objetivos, configuramos el entorno y recibimos tu información clave. Todo en menos de 48h.',
  },
  {
    number: '02',
    icon: Bot,
    title: 'Entrenamiento y Pruebas',
    description: 'Entrenamos el agente IA con tus datos, probamos respuestas y ajustamos el flujo según tus necesidades.',
  },
  {
    number: '03',
    icon: Workflow,
    title: 'Despliegue y Optimización',
    description: 'Lanzamos el sistema en producción, conectamos canales y medimos resultados para iterar.',
  },
];
      ...
      <div className="relative mx-auto max-w-6xl px-6 sm:px-8 md:px-12 lg:px-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-3xl font-semibold text-white sm:text-4xl md:text-5xl">
            Implementación clara en 3 pasos
          </h2>
          <p className="mt-4 text-sm leading-7 text-[#A1A1AA] sm:text-base">
            Un flujo corto, moderno y medible para pasar de idea a operación con IA.
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <span className="text-xs font-semibold tracking-[0.16em] text-[#71717A]">PASO {step.number}</span>
