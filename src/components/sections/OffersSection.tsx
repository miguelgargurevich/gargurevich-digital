...
const UI_LABELS = {
  es: {
    ...
    priceSubline: 'Pago único + 1 año incluido gratis.',
    ...
    summaryRows: [
      { plan: 'Cliente Nuevo en 48h' as const, annual: 'S/ 299 único pago', includes: 'Tu presencia digital lista para vender · 1 año completo incluido gratis · dominio, hosting y soporte incluidos · después del año: renuevas si decides continuar' },
      { plan: 'Máquina de Leads por WhatsApp' as const, annual: 'S/ 399 único pago', includes: 'Tu landing lista para convertir · 1 año completo incluido gratis · dominio, hosting, tracking y soporte incluidos · después del año: renuevas si decides continuar' },
      { plan: 'Control Total (editable por ti)' as const, annual: 'S/ 599 único pago', includes: 'Tu web lista y funcionando · 1 año completo incluido gratis · dominio, hosting, mantenimiento y soporte incluidos · después del año: renuevas mensual o anual con descuento · si no renuevas, la web puede suspenderse' },
      { plan: 'Negocio Digital Automatizado' as const, annual: 'S/ 999 único pago', includes: 'Tu negocio digital completo · 1 año completo incluido gratis · dominio, hosting, backups y soporte incluidos · después del año: renuevas mensual o anual con descuento' },
      ...
      { plan: 'Solo Marca (dominio + correos)' as const, annual: 'S/ 150 único pago', includes: 'Tu marca protegida desde el día 1 · 1 año incluido gratis · dominio y correos profesionales incluidos · después del año: renuevas si decides continuar' },
    ] as const,
  ...
  en: {
    ...
    summaryRows: [
      { plan: 'New Client in 48h' as const, annual: 'S/ 299 one-time payment', includes: 'Your digital presence ready to sell · 1 full year included free · domain, hosting and support included · after year one: renew if you decide to continue' },
      { plan: 'WhatsApp Lead Machine' as const, annual: 'S/ 399 one-time payment', includes: 'Your landing page ready to convert · 1 full year included free · domain, hosting, tracking and support included · after year one: renew if you decide to continue' },
      { plan: 'Full Control (editable by you)' as const, annual: 'S/ 599 one-time payment', includes: 'Your site ready and running · 1 full year included free · domain, hosting, maintenance and support included · after year one: renew monthly or annually with a discount · if you do not renew, the site may be suspended' },
      { plan: 'Automated Digital Business' as const, annual: 'S/ 999 one-time payment', includes: 'Your complete digital business · 1 full year included free · domain, hosting, backups and support included · after year one: renew monthly or annually with a discount' },
      ...
      { plan: 'Just Brand (domain + emails)' as const, annual: 'S/ 150 one-time payment', includes: 'Your brand protected from day one · 1 full year included free · domain and professional emails included · after year one: renew if you decide to continue' },
    ] as const,
