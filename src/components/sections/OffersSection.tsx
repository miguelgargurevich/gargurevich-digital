...
const UI_LABELS = {
  es: {
    ...
    summaryRows: [
      { plan: 'Cliente Nuevo en 48h' as const, annual: 'S/ 299', includes: 'Tu presencia digital lista para vender · 1 año completo incluido gratis · dominio, hosting y soporte incluidos · después del año: renuevas si decides continuar' },
      { plan: 'Máquina de Leads por WhatsApp' as const, annual: 'S/ 399', includes: 'Tu landing lista para convertir · 1 año completo incluido gratis · dominio, hosting, tracking y soporte incluidos · después del año: renuevas si decides continuar' },
      { plan: 'Control Total (editable por ti)' as const, annual: 'S/ 599', includes: 'Tu web lista y funcionando · 1 año completo incluido gratis · dominio, hosting, mantenimiento y soporte incluidos · después del año: renuevas mensual o anual con descuento · si no renuevas, la web puede suspenderse' },
      { plan: 'Negocio Digital Automatizado' as const, annual: 'S/ 999', includes: 'Tu negocio digital completo · 1 año completo incluido gratis · dominio, hosting, backups y soporte incluidos · después del año: renuevas mensual o anual con descuento' },
      ...
      { plan: 'Solo Marca (dominio + correos)' as const, annual: 'S/ 150', includes: 'Tu marca protegida desde el día 1 · 1 año incluido gratis · dominio y correos profesionales incluidos · después del año: renuevas si decides continuar' },
    ] as const,
