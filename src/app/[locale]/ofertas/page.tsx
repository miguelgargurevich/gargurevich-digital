...
const UI_LABELS = {
  es: {
    ...
    summaryRows: [
      { plan: 'Mi Negocio en Google',   annual: 'Dominio: según extensión (.com a .pe)', includes: 'Solo renovación de dominio · desde S/50/año (.com) hasta S/130/año (.pe) · sin mensualidad', ctaEs: 'Habla conmigo por WhatsApp ahora', ctaEn: 'Chat with me on WhatsApp now' },
      { plan: 'Landing WhatsApp',       annual: 'Dominio: según extensión (.com a .pe)', includes: 'Solo renovación de dominio · desde S/50/año (.com) hasta S/130/año (.pe) · sin mensualidad', ctaEs: 'Quiero mi web lista para vender', ctaEn: 'I want my web ready to sell' },
      { plan: 'Web que yo mismo edito', annual: 'Dominio: según extensión + S/ 19/mes', includes: 'El dominio es tuyo para siempre · desde S/50 a S/130/año según extensión · mensualidad es opcional y puedes cancelar cuando quieras · hosting incluido', ctaEs: 'Dame control total', ctaEn: 'Give me full control' },
      { plan: 'Sueño Digital Completo', annual: 'Dominio: según extensión + S/ 39/mes', includes: 'El dominio es tuyo para siempre · desde S/50 a S/130/año según extensión · mensualidad es opcional y puedes cancelar cuando quieras · hosting, soporte y backups incluidos', ctaEs: 'Quiero todo resuelto', ctaEn: 'I want everything solved' },
      { plan: 'Mantenimiento Web Perú', annual: 'Dominio: según extensión + S/ 79–149/mes', includes: 'Aplica a una web que ya tienes · desde S/50 a S/130/año según extensión · mensualidad es flexible según tus necesidades', ctaEs: 'Protege tu web ahora', ctaEn: 'Protect my website now' },
      { plan: 'Solo dominio + correos', annual: 'S/ 150/año', includes: 'Dominio .pe o .com.pe · Redirección de correos: lo que llegue a @tudominio.pe se reenvía a tu Gmail · gestión de dominio incluida · sin mensualidad', ctaEs: 'Agenda una llamada', ctaEn: 'Schedule a call' },
    ] as const,
