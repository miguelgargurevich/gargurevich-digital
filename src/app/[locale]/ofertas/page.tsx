...
const UI_LABELS = {
  es: {
    ...
    summaryRows: [
      ...
      { plan: 'Blindaje Digital',     annual: 'Dominio: según extensión + S/ 79–149/mes', includes: 'Aplica a una web que ya tienes · desde S/50 a S/130/año según extensión · mensualidad es flexible según tus necesidades', ctaEs: 'Protege tu web ahora', ctaEn: 'Protect my website now' },
  ...
  en: {
    ...
    summaryRows: [
      ...
      { plan: 'Digital Shield',       annual: 'Domain: by extension + S/ 79–149/mo', includes: 'Applies to a website you already have · from S/50 to S/130/yr by extension · monthly fee is flexible based on your needs', ctaEs: 'Protect my website now', ctaEn: 'Protect my website now' },
