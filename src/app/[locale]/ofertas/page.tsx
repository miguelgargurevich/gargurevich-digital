...
const UI_LABELS = {
  es: {
    ...
    summaryRows: [
      ...
      { plan: 'Presencia Online Rápida', annual: 'S/ 150/año', includes: 'Dominio .pe o .com.pe · Correos profesionales con tu marca · gestión de dominio incluida · sin mensualidad', ctaEs: 'Agenda una llamada', ctaEn: 'Schedule a call' },
    ] as const,
  ...
  en: {
    ...
    summaryRows: [
      ...
      { plan: 'Quick Online Presence',annual: 'S/ 150/yr', includes: 'Domain .pe or .com.pe · Professional emails with your brand · domain management included · no monthly fee', ctaEs: 'Schedule a call', ctaEn: 'Schedule a call' },
    ] as const,
