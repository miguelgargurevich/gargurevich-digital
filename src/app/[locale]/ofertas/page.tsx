...
const UI_LABELS = {
  es: {
    ...
    summaryRows: [
      { plan: 'Startup Digital',     annual: 'Dominio: según extensión (.com a .pe)', includes: 'Solo renovación de dominio · desde S/50/año (.com) hasta S/130/año (.pe) · sin mensualidad', ctaEs: 'Habla conmigo por WhatsApp ahora', ctaEn: 'Chat with me on WhatsApp now' },
      { plan: 'Captador de Clientes', annual: 'Dominio: según extensión (.com a .pe)', includes: 'Solo renovación de dominio · desde S/50/año (.com) hasta S/130/año (.pe) · sin mensualidad', ctaEs: 'Quiero mi web lista para vender', ctaEn: 'I want my web ready to sell' },
      { plan: 'Independencia Digital', annual: 'Dominio: según extensión + S/ 19/mes', includes: 'El dominio es tuyo para siempre · desde S/50 a S/130/año según extensión · mensualidad es opcional y puedes cancelar cuando quieras · hosting incluido', ctaEs: 'Dame control total', ctaEn: 'Give me full control' },
      { plan: 'Sistema Completo',      annual: 'Dominio: según extensión + S/ 39/mes', includes: 'El dominio es tuyo para siempre · desde S/50 a S/130/año según extensión · mensualidad es opcional y puedes cancelar cuando quieras · hosting, soporte y backups incluidos', ctaEs: 'Quiero todo resuelto', ctaEn: 'I want everything solved' },
      { plan: 'Blindaje Digital',     annual: 'Dominio: según extensión + desde S/ 79/mes', includes: 'Aplica a una web que ya tienes · desde S/50 a S/130/año según extensión · mensualidad es flexible según tus necesidades', ctaEs: 'Protege tu web ahora', ctaEn: 'Protect my website now' },
      { plan: 'Presencia Online Rápida', annual: 'S/ 150/año', includes: 'Dominio .pe o .com.pe · Correos profesionales con tu marca · gestión de dominio incluida · sin mensualidad', ctaEs: 'Quiero mi dominio propio', ctaEn: 'I want my own domain' },
    ] as const,
  ...
  en: {
    ...
    summaryRows: [
      { plan: 'Digital Startup',      annual: 'Domain: by extension (.com to .pe)', includes: 'Domain renewal only · from S/50/yr (.com) to S/130/yr (.pe) · no monthly fee', ctaEs: 'Chat with me on WhatsApp now', ctaEn: 'Chat with me on WhatsApp now' },
      { plan: 'Customer Converter',   annual: 'Domain: by extension (.com to .pe)', includes: 'Domain renewal only · from S/50/yr (.com) to S/130/yr (.pe) · no monthly fee', ctaEs: 'I want my web ready to sell', ctaEn: 'I want my web ready to sell' },
      { plan: 'Digital Independence', annual: 'Domain: by extension + S/ 19/mo', includes: 'The domain is yours forever · from S/50 to S/130/yr by extension · monthly fee is optional and you can cancel anytime · hosting included', ctaEs: 'Give me full control', ctaEn: 'Give me full control' },
      { plan: 'Complete System',      annual: 'Domain: by extension + S/ 39/mo', includes: 'The domain is yours forever · from S/50 to S/130/yr by extension · monthly fee is optional and you can cancel anytime · hosting, support and backups included', ctaEs: 'I want everything solved', ctaEn: 'I want everything solved' },
      { plan: 'Digital Shield',       annual: 'Domain: by extension + from S/ 79/mo', includes: 'Applies to a website you already have · from S/50 to S/130/yr by extension · monthly fee is flexible based on your needs', ctaEs: 'Protect my website now', ctaEn: 'Protect my website now' },
      { plan: 'Quick Online Presence',annual: 'S/ 150/yr', includes: 'Domain .pe or .com.pe · Professional emails with your brand · domain management included · no monthly fee', ctaEs: 'I want my own domain', ctaEn: 'I want my own domain' },
    ] as const,
