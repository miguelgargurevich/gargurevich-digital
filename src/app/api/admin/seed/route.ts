...
const OFFERS_SEED = [
  {
    ...
    order: 0,
    popular: false,
    nameEs: 'Capa 1 — Presencia Digital',
    nameEn: 'Layer 1 — Digital Presence',
  ...
  },
  {
    ...
    order: 1,
    popular: true,
    nameEs: 'Capa 2 — Agente IA',
    nameEn: 'Layer 2 — AI Agent',
  ...
  },
  {
    ...
    order: 2,
    popular: false,
    nameEs: 'Capa 3 — Automatización',
    nameEn: 'Layer 3 — Automation',
  ...
  },
  {
    ...
    order: 3,
    popular: false,
    nameEs: 'Capa 4 — Memoria Empresarial',
    nameEn: 'Layer 4 — Enterprise Memory',
