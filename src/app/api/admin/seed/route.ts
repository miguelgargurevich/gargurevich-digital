...
const OFFERS_SEED = [
  {
    ...
    price: 'S/ 299',
    priceNoteEs: 'Setup + 1 año incluido',
    priceNoteEn: 'Setup + 1 year included',
    descriptionEs: 'Empieza a captar clientes hoy. Incluye dominio, hosting y soporte durante 1 año. Luego renuevas solo si quieres seguir activo.',
    descriptionEn: 'Start capturing clients today. Includes domain, hosting and support for 1 year. After that, renew only if you want to keep it active.',
    itemsEs: [
  ...
  },
  {
    ...
    priceNoteEs: 'Setup + 1 año incluido',
    priceNoteEn: 'Setup + 1 year included',
    descriptionEs: 'Convierte cada click de tus anuncios en un cliente real. Incluye dominio, hosting y seguimiento durante 1 año; después renuevas de forma opcional.',
    descriptionEn: 'Turn every ad click into a real customer. Includes domain, hosting and tracking for 1 year; after that, renewal is optional.',
    itemsEs: [
  ...
  },
  {
    ...
    price: 'S/ 599',
    priceNoteEs: 'Setup + 1 año incluido + renovación opcional',
    priceNoteEn: 'Setup + 1 year included + optional renewal',
    descriptionEs: 'Tu web, tu control. Incluye dominio, hosting y panel durante 1 año. Después puedes renovar solo si deseas seguir con soporte y mantenimiento.',
    descriptionEn: 'Your website, your control. Includes domain, hosting and dashboard for 1 year. After that, you can renew only if you want to keep support and maintenance.',
    itemsEs: [
  ...
  },
  {
    ...
    order: 3,
    popular: false,
    nameEs: 'Negocio Digital Automatizado',
    nameEn: 'Automated Digital Business',
    price: 'S/ 999',
    priceNoteEs: 'Setup + 1 año incluido + renovación opcional',
    priceNoteEn: 'Setup + 1 year included + optional renewal',
    descriptionEs: 'Todo lo que un negocio serio necesita: web profesional, blog, analítica y soporte dedicado, con dominio y hosting incluidos por 1 año.',
    descriptionEn: 'Everything a serious business needs: professional website, blog, analytics and dedicated support, with domain and hosting included for 1 year.',
    itemsEs: [
