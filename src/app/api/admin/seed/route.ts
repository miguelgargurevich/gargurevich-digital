...
const OFFERS_SEED = [
  {
    ...
    descriptionEs: 'Aparece en Google Maps y en internet en menos de 48 horas. Sin complicaciones.',
    descriptionEn: 'Get found on Google Maps and online in under 48 hours. No hassle.',
    itemsEs: [
      'Ficha de Google Maps optimizada',
      'Página de 1 sección (nombre, horario, WhatsApp, dirección)',
      'Dominio .com.pe por 1 año incluido',
      'Entrega en 48 horas',
    ],
    itemsEn: [
      'Optimized Google Maps listing',
      'Single-section page (name, hours, WhatsApp, address)',
      '.com.pe domain for 1 year included',
      'Delivered in 48 hours',
    ],
    ctaEs: 'Quiero aparecer en Google',
    ctaEn: 'Get me on Google',
    forWhoEs: 'Ideal para: emprendedores que aún no tienen nada en internet.',
    forWhoEn: 'Best for: entrepreneurs who have nothing online yet.',
  },
  {
    ...
    ctaEn: 'Start selling',
    forWhoEs: 'Ideal para: negocios que anuncian en Facebook o Instagram.',
    forWhoEn: 'Best for: businesses advertising on Facebook or Instagram.',
  },
  {
    ...
    price: 'S/ 450',
    priceNoteEs: 'Único + S/ 30/mes',
    priceNoteEn: 'One-time + S/ 30/mo',
    descriptionEs: 'Tu web de 3 páginas con panel sencillo para que cambies horarios, fotos y promos sin pedir ayuda.',
    descriptionEn: 'A 3-page website with a simple panel so you can update hours, photos, and promos on your own.',
    itemsEs: [
      '3 páginas: Inicio, Servicios, Contacto',
      'Panel de edición sencillo incluido',
      'Cambia textos, fotos y promos tú mismo',
      'Capacitación de 1 hora incluida',
    ],
    itemsEn: [
      '3 pages: Home, Services, Contact',
      'Simple editing panel included',
      'Update texts, photos and promos yourself',
      '1-hour training included',
    ],
    ctaEs: 'Quiero autonomía',
    ctaEn: 'I want autonomy',
    forWhoEs: 'Ideal para: dueños que quieren no depender de nadie para actualizar su web.',
    forWhoEn: 'Best for: owners who want full independence to update their website.',
  },
  {
    ...
    price: 'S/ 900',
    priceNoteEs: 'Único + S/ 59/mes',
    priceNoteEn: 'One-time + S/ 59/mo',
    ...
    itemsEs: [
      ...
      '2 correos corporativos (@tudominio)',
      'Dominio .pe incluido por 1 año',
      'Soporte mensual por WhatsApp',
      'Backups semanales automáticos',
    ],
    itemsEn: [
      'Full corporate website + Blog',
      '2 corporate emails (@yourdomain)',
      '.pe domain included for 1 year',
      'Monthly WhatsApp support',
  ...
  },
  {
    ...
    descriptionEs: 'Olvídate de tu web. La mantenemos viva, segura y actualizada cada mes.',
    descriptionEn: 'Forget about your website. We keep it alive, secure, and updated every month.',
    itemsEs: [
      'Copias de seguridad mensuales',
      'Hasta 2 cambios de textos o fotos al mes',
    ...
    itemsEn: [
      'Monthly backups',
      'Up to 2 text or photo updates per month',
    ...
    forWhoEn: 'Best for: businesses with a website who have no time to maintain it.',
  },
];
